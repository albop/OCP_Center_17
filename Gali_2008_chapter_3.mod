 ...
 * Modified for Hui He (ICD@IMF) on June 3, 2016
 *
...
parameters alppha ${\alppha}$ (long_name='capital share')
    ...
    Omega    // composite parameter 1
    psi_n_ya // composite parameter 2
    lambda   // composite parameter 3
    kappa    // composite parameter 4
    psi_n_y  // composite parameter 5
    ;
%----------------------------------------------------------------
